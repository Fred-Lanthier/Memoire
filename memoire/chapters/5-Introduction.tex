...
tion of Vision-Language Models (VLMs) for autonomous food acquisition planning, and the
implementation of the food perception and manipulation modules. Chapter 5 presents the
experimental results, including an analysis of VLM-based food acquisition planning perfor-
