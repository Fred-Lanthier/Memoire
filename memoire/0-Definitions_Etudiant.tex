...
\newcommand\monTitre{Exécution sécurisée de trajectoires générées par Flow Matching à l'aide de fonctions barrières de contrôle pour la manipulation robotique}
...
\newcommand\mesMotsClef{Exécution sécurisée de trajectoires générées par Flow Matching à l'aide de fonctions barrières de contrôle pour la manipulation robotique, Vision par ordinateur}
%%
